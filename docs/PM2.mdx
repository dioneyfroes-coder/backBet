...
`APP_NAME` é o nome do produto e `SERVICE_NAME` identifica a instância operacional. `SERVICE_NAME` alimenta `OTEL_SERVICE_NAME` e métricas. Ajuste ambos no `.env` antes de iniciar o PM2.
:::
