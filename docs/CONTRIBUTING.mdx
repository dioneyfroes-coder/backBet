...
- Alterou comportamento público? Atualize o doc correspondente (`docs/ARCHITECTURE`, `docs/API_CONTRACT`, `docs/OBSERVABILITY`, `docs/QUICKSTART`).
- Mantenha exemplos de payloads e env vars consistentes (ex.: `CACHE_ENABLED`, `TRACING_ENABLED`, `RATE_LIMIT_*`).
- Adicione logs/snapshots/traces quando implementar novos fluxos críticos. Documente brevemente no PR onde encontrar esses sinais.
