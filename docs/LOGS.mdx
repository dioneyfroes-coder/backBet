...
3. Os agentes transmitem para o Loki / Elasticsearch definido internamente (os arquivos antigos em `reports/phase4/alerts.yaml` ficaram apenas como referência histórica).
...
- [ ] Documentou novos campos nesta página e, se necessário, no plano `docs/PM2-WEBUI-MIGRATION.mdx`?
