...
assignDefault('PIX_WEBHOOK_ENABLED', 'true');
assignDefault('PIX_WEBHOOK_SECRET', 'backbet-mock-webhook-secret');
assignDefault('PIX_CHARGE_TTL_MS', '300000');
...
type AppEnv = NodeJS.ProcessEnv & {
  ...
  PIX_WEBHOOK_ENABLED?: string;
  PIX_WEBHOOK_SECRET?: string;
  PIX_CHARGE_TTL_MS?: string;
