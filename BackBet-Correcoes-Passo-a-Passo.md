...
5. revisar branch coverage dos fluxos financeiros ✓ revisado em 22/09 e consolidado na 2ª passada: global branch 67,4%→70,06% / stmts 84→85,47% / fns 80,7→82,59%; +59 testes (1167) na rodada 1 (restoreBet 89%, Withdraw 100%, transfers tesouraria 100%, RiskExposureUnderflowError 100%, BullWithdrawalQueue 67%) e rodada 2 (EventCatalogService 0→93% br, PurchaseCreditPackage →100% br, CreditPackageRepository 0→100%, WithdrawalRequestService 63→100% br/90% st, financeReconciliation 54→89% br/94% st)
